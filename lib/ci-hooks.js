...
var options = { method: 'POST',
  ...
  headers: 
     ...
     authorization: 'token 663b685800f34a2c12bc9a94c60f4ed9684e8d7e' },
  body: 
   { name: 'travis',
     active: true,
...
module.exports = function setupHooks( repoName ) {
	console.log( `/repos/${config.organization}/${repoName}` );
	return request({ 
		method: 'POST',
		url: '/auth/github',
		headers: { 
	...
	.then( () => request({ 
		method: 'GET',
		url: `/repos/${config.organization}/${repoName}`
	}))
